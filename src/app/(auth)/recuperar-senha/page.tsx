      ...
      <div className="hidden w-1/2 flex-col bg-blue-600 p-10 text-white lg:flex">
        ...
        <div className="space-y-4">
          ...
          <p className="text-blue-100">
            Enviaremos um link para o seu email para que você possa redefinir
            sua senha com segurança e voltar a acessar todos os recursos do
            portal.
          </p>
        </div>
      </div>
          ...
          {success ? (
            <div className="rounded-lg bg-white p-6 text-center">
              ...
              <p className="mb-6 text-gray-600">
                Enviamos um link de recuperação para {email}. Por favor,
