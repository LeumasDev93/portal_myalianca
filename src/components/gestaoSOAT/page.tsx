  ...
  return (
    <div className="p-3 md:p-4 w-full mt-4 md:mt-6">
      ...
      <div className="mb-4 md:mb-5 lg:mb-6">
        <h2 className="text-sm md:text-base lg:text-lg font-semibold text-[#002256] mb-2 md:mb-3">Buscar</h2>
        <div className="flex flex-col sm:flex-row gap-2 md:gap-3 justify-between">
          ...
          <div className="flex gap-2 md:gap-3 flex-shrink-0">
            <button
              ...
              className="px-3 py-2 md:px-4 md:py-2.5 lg:px-6 lg:py-3 text-xs md:text-sm lg:text-base rounded-lg font-medium flex items-center justify-center gap-1.5 md:gap-2 transition-colors bg-[#002256] hover:bg-[#002256]/90 text-white disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            >
              {downloadTemplateLoading ? (
                <FaSpinner className="animate-spin w-3.5 h-3.5 md:w-4 md:h-4" />
              ) : (
                <FaDownload className="w-3.5 h-3.5 md:w-4 md:h-4" />
              )}
            ...
            <button
              ...
              className="px-3 py-2 md:px-4 md:py-2.5 lg:px-6 lg:py-3 text-xs md:text-sm lg:text-base rounded-lg font-medium flex items-center justify-center gap-1.5 md:gap-2 transition-colors bg-[#B7021C] hover:bg-[#B7021C]/90 text-white whitespace-nowrap"
              title={
                hasPendingSoat
            ...
            >
              <FaPlus className="w-3.5 h-3.5 md:w-4 md:h-4" />
