...
export default function PageGestaoSOAT() {
  ...
  return (
    <div className="p-3 sm:p-3 md:p-4 lg:p-4 w-full mt-4 sm:mt-4 md:mt-5 lg:mt-6">
      <div className="mb-3 sm:mb-4 md:mb-5 lg:mb-6">
        <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-[#002256] mb-2">
          Gestão de SOAT
        </h1>
        <p className="text-xs sm:text-xs md:text-sm text-[#002856]">
      ...
      <div className="mb-3 sm:mb-4 md:mb-5 lg:mb-8">
        <StatisticsCard statistics={soatStats} />
      </div>

      {/* Seção Buscar */}
      <div className="mb-3 sm:mb-4 md:mb-5 lg:mb-6">
        <h2 className="text-sm sm:text-base md:text-base lg:text-lg font-semibold text-[#002256] mb-2">Buscar</h2>
        <div className="flex flex-col sm:flex-row gap-2 justify-between">
          <div className="sm:w-1/2 w-full relative">
            <input
              ...
              className="w-full pl-8 sm:pl-9 md:pl-10 pr-8 sm:pr-9 md:pr-10 py-2 sm:py-2 md:py-2.5 lg:py-3 border border-gray-300 rounded-lg focus:outline-none text-xs sm:text-xs md:text-sm lg:text-base"
            />
            <FaSearch className="absolute left-2 sm:left-2.5 md:left-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-xs sm:text-sm md:text-base" />
            {searchQuery && (
              <button
                onClick={() => setSearchQuery("")}
                className="absolute right-2 sm:right-2.5 md:right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 text-xs sm:text-sm md:text-base"
              >
                ✕
              </button>
            )}
          </div>
          <div className="flex gap-2 sm:gap-2 md:gap-2.5 lg:gap-3 flex-shrink-0">
            <button
              onClick={handleDownloadTemplate}
              disabled={downloadTemplateLoading}
              className="px-2 py-2 sm:px-2.5 sm:py-2 md:px-3 md:py-2 lg:px-6 lg:py-3 text-xs sm:text-xs md:text-sm lg:text-base rounded-lg font-medium flex items-center gap-1 sm:gap-1 md:gap-1.5 lg:gap-2 transition-colors bg-[#002256] hover:bg-[#002256]/90 text-white disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            >
              {downloadTemplateLoading ? (
                <FaSpinner className="animate-spin w-3 h-3 sm:w-3 sm:h-3 md:w-4 md:h-4" />
              ) : (
                <FaDownload className="w-3 h-3 sm:w-3 sm:h-3 md:w-4 md:h-4" />
              )}
            ...
            <button
              ...
              className="px-2 py-2 sm:px-2.5 sm:py-2 md:px-3 md:py-2 lg:px-6 lg:py-3 text-xs sm:text-xs md:text-sm lg:text-base rounded-lg font-medium flex items-center gap-1 sm:gap-1 md:gap-1.5 lg:gap-2 transition-colors bg-[#B7021C] hover:bg-[#B7021C]/90 text-white whitespace-nowrap"
              title={
                hasPendingSoat
            ...
            >
              <FaPlus className="w-3 h-3 sm:w-3 sm:h-3 md:w-4 md:h-4" />
