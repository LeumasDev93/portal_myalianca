                  ...
                  <div className="flex flex-col sm:flex-row gap-3 items-center justify-between">
                    <div className="text-xs sm:text-sm text-gray-600">
                      <p className="flex items-center gap-2">
                        ...
                        Lat: {selectedAgencia.latitude}, Long: {selectedAgencia.longitude}
                      </p>
                    </div>
                    <a
                      ...
                      className="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 text-xs sm:text-sm font-medium text-white bg-[#002256] rounded-md hover:bg-[#002256]/90 transition-colors"
                    >
                      <FaMapMarker className="mr-2 h-3 w-3 sm:h-4 sm:w-4" />
